...
public class ApplicationStateMachine {
    ...
    private static final Map<ApplicationStatus, Set<ApplicationStatus>> ALLOWED_TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(ApplicationStatus.DECISION_PENDING, Set.of(ApplicationStatus.APPROVED, ApplicationStatus.DECLINED, ApplicationStatus.REFERRED, ApplicationStatus.EXPIRED)),
            Map.entry(ApplicationStatus.REFERRED, Set.of(ApplicationStatus.APPROVED, ApplicationStatus.DECLINED)),
