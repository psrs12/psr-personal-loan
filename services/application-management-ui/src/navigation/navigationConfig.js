 ...
 *   | { kind: 'web-component', tag: string, scriptUrlKey: string, apiBaseUrlKey: string, attributes: string[] }
 *   | { kind: 'internal-mfe', component: 'OfferAcceptanceMfe' }
...
export const NAVIGATION_CONFIG = {
  ...
  APPROVED: { kind: 'internal-mfe', component: 'OfferAcceptanceMfe' },
  ...
  OFFER_ACCEPTED: POST_ACCEPTANCE_BLOCK('Offer Accepted', 'Your offer has been accepted. We are now arranging the transfer of funds.'),
